...
const page = () => {
  return (
    <>
    <section className="w-full md:w-[60vw] my-10 mx-auto py-10 min-h-screen bg-white">
        <div className=" py-4 mx-auto lg:py-6 md:px-6">
            <div className="flex flex-wrap ">
                ...
                <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                    <img src="https://source.unsplash.com/random/1400×1200/?village,farm,fields" alt=""
                        className="relative object-cover w-full h-full rounded z-0"/>
                </div>
            </div>
        </div>
    </section>
