...
const page = () => {
  ...
  const removeInvi = async (id) => {
    const res = await fetch("/api/invitation/removeInvitation", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
      ...
      <section className="text-gray-600 min-h-screen body-font">
        <div className="container px-5 py-10 mx-auto">
          <div className="flex flex-col text-center w-full md:w-[80vw] mx-auto">
            ...
            >
              {addInvitation ? "Cancel" : "Add New Invitation"}
            </button>
          </div>
          {addInvitation && (
