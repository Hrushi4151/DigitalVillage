          ...
          {verified.status === 200 && (
            <section className="text-gray-600 body-font">
              <button
                ...
                type="submit"
                className="block  rounded-md bg-green-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
              >
                {addImage ? "Cancel" : "Add Your Image"}
              </button>
              {addImage && (
                      ...
                      <div>
                        ...
                        <div className="mt-2.5">
                          ...
                          onChange={handleChange}
                            value={verified.decoded.name || userdata.name}
                            type="text"
                            name="name"
                            id="name"
                            autoComplete="off"
